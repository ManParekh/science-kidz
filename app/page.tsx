...
const COURSES_DATA = [
  ...
  {
    img: "/Computing-With-Arduino.jpg",
  ...
  {
    img: "/Block-Coding-With-Scratch.jpg",
  ...
  {
    img: "/Python-AI-With-Computer-Vision.jpg",
          ...
          <div className="relative h-[300px] w-[300px] sm:h-[400px] sm:w-[400px] md:h-[500px] md:w-[500px] lg:h-[600px] lg:w-[600px]">
            <div className="absolute h-full w-full left-0 top-0">
              <Image
                ...
                height={50}
                width={50}
                className="absolute bg-transparent md:left-[70%] md:bottom-12 lg:left-[71%] lg:bottom-14 lg:w-9 md:w-7 sm:w-7 w-5 sm:bottom-9 sm:right-24 z-30 right-[68px] bottom-6"
              />
              <div
                className="absolute md:left-[70%] md:bottom-16 lg:left-[71%] lg:bottom-[78px] lg:w-9 lg:h-9 md:w-7 md:h-7 sm:w-7 sm:h-7 w-5 h-5 rounded-full sm:bottom-14 sm:right-24 z-30 right-[68px] bottom-9 animate-blinking-light"
              ...
              <Image
                ...
                height={100}
                width={100}
                className="absolute h-14 w-14 md:h-[100px] md:w-[100px] -left-10 top-20 animate-slow-spin"
              />
              <Image
                src="/gear.png"
                alt="gear"
                ...
                height={80}
                width={80}
                className="absolute -left-5 bottom-24 md:-left-10 h-8 w-8 md:h-[70px] md:w-[70px] md:bottom-48 animate-reverse-slow-spin"
              />
              <Image
                src="/gear.png"
                alt="gear"
                ...
                height={80}
                width={80}
                className="absolute left-[50%] h-[40px] w-[40px] md:h-[90px] bottom-16 md:w-[90px] md:bottom-20 animate-reverse-slow-spin"
              />
              <Image
                src="/gear.png"
                alt="gear"
                ...
                height={30}
                width={30}
                className="absolute left-[40%] top-[50%] animate-spin"
              />
              <Image
                src="/gear.png"
                alt="gear"
                ...
                height={70}
                width={70}
                className="absolute right-[10px] h-[40px] w-[40px] bottom-14 md:right-[40px] md:h-[70px] md:w-[70px] md:bottom-[130px] animate-slow-spin"
              />
              <Image
                src="/gear.png"
                alt="gear"
                ...
                height={100}
                width={100}
                className="absolute h-14 w-14 md:h-[100px] md:w-[100px] -right-10 top-36 animate-slow-spin"
              />
            </div>
            <Image
              src="/characters.png"
